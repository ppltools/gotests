...
import (
	...
	"github.com/ppltools/gotests/internal/models"
	"github.com/ppltools/gotests/internal/render/bindata"
)
...
func TestFunction(w io.Writer, f *models.Function, printInputs bool, subtests bool, allowError bool) error {
